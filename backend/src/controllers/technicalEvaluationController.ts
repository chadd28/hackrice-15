...
import type { TechnicalEvaluationResult, EvaluationConfig } from '../services/technicalEvaluatorService';
 ...
 */
export const initializeEvaluator = async (req: Request, res: Response) => {
  try {
 ...
 */
export const evaluateTechnicalAnswer = async (req: Request, res: Response) => {
  try {
    ...
    // Evaluate the answer
    const result: TechnicalEvaluationResult = await evaluator.evaluateAnswer(
      questionId, 
      userAnswer.trim(),
      config as Partial<EvaluationConfig>
    );
 ...
 */
export const evaluateBatchTechnicalAnswers = async (req: Request, res: Response) => {
  try {
    ...
    const results: TechnicalEvaluationResult[] = await evaluator.evaluateBatch(
      evaluations,
      config as Partial<EvaluationConfig>
    );
 ...
 */
export const getTechnicalQuestion = async (req: Request, res: Response) => {
  try {
 ...
 */
export const getAllTechnicalQuestions = async (req: Request, res: Response) => {
  try {
 ...
 */
export const getEvaluatorStatus = async (req: Request, res: Response) => {
  try {
    const evaluator = getTechnicalEvaluator();
    const status = evaluator.getStatus();
