...
import { initializeEvaluator, evaluateTechnicalAnswer, evaluateBatchTechnicalAnswers, getTechnicalQuestion, getAllTechnicalQuestions, getEvaluatorStatus, healthCheck } from '../controllers/technicalEvaluationController';
const router = Router();
/**
